...
def select_dependent_versions(
    ...
    while to_process:
        ...
        """At most one version of any package may be installed.

        While SAT solvers admit many ways to model "cardinality constraints", we choose
        a simple "pairwise" model that adds the constraint.
        ...
        """For each dependency DEP, we need a clause that says "if next_package is
        chosen, one of DEP's allowed versions must be installed.".
